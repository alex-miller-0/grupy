					...
					if start <= i and i<= end and start != 0 and end != 0:
						...
						if len( line.split() ) == 6:
							...
							if i == incount + 1 :
								...
								dynmat[x][qcount-1][(3*col)].append( a )
								dynmat[x][qcount-1][(3*col)].append( b )
								dynmat[x][qcount-1][(3*col)].append( c ) #Throwing out imaginary columns
														  # (They should be 0 anyway)
							if i == incount + 2 :
								...
								dynmat[x][qcount-1][1 + (3*col)].append( a)
								dynmat[x][qcount-1][1 + (3*col)].append( b )
								dynmat[x][qcount-1][1 + (3*col)].append( c )
							...
							if i == incount + 3 :
								...
								dynmat[x][qcount-1][2 + (3*col)].append( a )
								dynmat[x][qcount-1][2 + (3*col)].append( b )
								dynmat[x][qcount-1][2 + (3*col)].append( c )
